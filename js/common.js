$(document).ready(function() {
	...
	$(".btn-main_catalog").click(function(e) {
		e.preventDefault();
	...
	$('.slider-billbord').slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		prevArrow: '<div class="slick-prev arrow-billbord"><img src="img/prev1.svg" alt="alt"></div>',
		nextArrow: '<div class="slick-next arrow-billbord"><img src="img/next1.svg" alt="alt"></div>',
	});
